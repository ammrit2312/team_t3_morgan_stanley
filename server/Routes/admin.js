...
// api for doing stuff once an activity is archived
router.put("/unassign-volunteer/:aid",async(req,res) => {
    try {
        const assigned_users = await Activity.findById(req.params.aid,{_id:0,AssignedTo:1})
