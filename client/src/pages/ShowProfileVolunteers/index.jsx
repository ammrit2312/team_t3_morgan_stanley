...
import { MdEmail, MdOutlineWork, MdHearing, MdAssignmentInd } from "react-icons/md";
        ...
        <main className={styles.container}>
            ...
            <div className={styles.details}>
                ...
                <div className={styles.cardsContainer}>
                    {/* Basic Details */}
                    <div>
                        <h1 className={`${styles.title} ${styles.cards} ${styles.colorDetails}`}>Basic Details</h1>
                    ...
                    <div>
                        <h1 className={`${styles.title} ${styles.cards} ${styles.colorDetails}`}>Other Details</h1>
                        <div className={`${styles.cards} ${styles.containerCard}`}>
                            <IconCard
                                title="Nationality"
                    ...
                    <div>
                        <h1 className={`${styles.title} ${styles.cards} ${styles.colorDetails}`}>Preferences</h1>
                        <div className={`${styles.cards} ${styles.containerCard}`}>
                            <IconCard
                                title="Hear about us"
                    ...
                    <div>
                        <h1 className={`${styles.title} ${styles.cards} ${styles.colorDetails}`}>Statistics</h1>
                        <div className={`${styles.cards} ${styles.containerCard}`}>
                            <IconCard
                                title="Assigned"
